...
require('lazy').setup({
  {
    ...
    config = function()
      -- CLANGD DOESN'T WORK WITHOUT INSTALLING: sudo apt install libstdc++-12-dev
...
--  See `:help 'clipboard'`
--  NOTE: install 'xclip' package in order for it to work
...
vim.keymap.set('n', '<leader>e', vim.diagnostic.open_float, { desc = 'Open diagnostic messages' })
